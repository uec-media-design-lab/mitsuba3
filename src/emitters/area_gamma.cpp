...
class AreaLight_Gamma final : public Emitter<Float, Spectrum> {
public:
    MI_IMPORT_BASE(Emitter, m_flags, m_shape, m_medium)
    MI_IMPORT_TYPES(Scene, Shape, Texture)

    AreaLight_Gamma(const Properties &props) : Base(props) {
...
MI_IMPLEMENT_CLASS_VARIANT(AreaLight_Gamma, Emitter)
MI_EXPORT_PLUGIN(AreaLight_Gamma, "Area emitter(gamma)")
